                    ...
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                			<div class="form-group" autofocus="true">
                                ...
                                <input  type="text" id="ente_publico" name="ente_publico" value="<?php if ($error!="") echo $ente_publico; else echo $resultado[ente_publico]; ?>" class="form-control" size="50" maxlength="50"/>
                            </div>
