...
//        echo "<script type='text/javascript'>window.location.href='index.php'</script>";
	...
	$query="SELECT update_responder_punto($id_punto,'$instruccion',$decision,$condicion)";
        $result = pg_query($query)or die(pg_last_error());
...
<?php if ((isset($_POST[save])) and ($error=="bien")){	?> <!-- Mostrar Mensaje -->
            ...
            <div class="form-group" align="center"> 
                <h3 class="info">   
                    <font size="2">                         
                        <h1>Punto de Cuenta Resuelto con &eacute;xito</h1> 
                        <br />
                        <script type="text/javascript">
                    ...
                    <form method="POST" action="<?php echo $pagina?>" id="QForm" name="QForm" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" align="right">
                                ...
                                echo '<label class="radio-inline">
                                    <input id="decision" name="decision" value="1" checked="true" type="radio"> 
                                    APROBADO
                                </label>

                                <label class="radio-inline">
                                    <input id="decision" name="decision" value="2" type="radio"> 
                                    <font color="RED">NEGADO</font>
                                </label>
                                <label class="radio-inline">
                                    <input id="decision" name="decision" value="3" type="radio">
                                    <font color="blue">DEFERIDO</font>
                                </label>';
                                }elseif ($result_usuarios[decision]==2) {
                                echo '<label class="radio-inline">
                                    <input id="decision" name="decision" value="1" type="radio"> 
                                    APROBADO
                                </label>

                                <label class="radio-inline">
                                    <input id="decision" name="decision" value="2" checked="true" type="radio"> 
                                    <font color="RED">NEGADO</font>
                                </label>
                                ...
                                <label class="radio-inline">
                                    <input id="decision" name="decision" value="3" checked="true" type="radio">
                                    <font color="blue">DEFERIDO</font>
                                </label>';
                                }
                                ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="instruccion" id="instruccion" cols="70" rows="3"><?php echo $result_usuarios[instruccion];?></textarea>
                            </div>
                            <input type="submit" class="btn btn-default" name="save" value="  Responder  " >
