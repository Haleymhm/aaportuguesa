...
?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td align="center"> 
                                <a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?view=partido_politico_drop&id_partido=<?php echo $resultados[id_partido];?>" title="Pulse para eliminar el registro">
                                    <img border="0" src="images/borrar28.png" alt="borrar">
                                </a>
                                <a href="index2.php?view=partido_politico_update&id_partido=<?php echo $resultados[id_partido];?>" title="Pulse para Modificar los datos registrados">
                        ...
                        <tr align="center">
                            <th colspan="3" align="center">
                                <div id="cpanel">
                                    ...
                                    <div style="float:right;">
                                        <div class="icon">
                                            <a href="index2.php?view=partido_politico_add" class="btn btn-default">
                                                Agregar
                                            </a>
                                        </div>
                                    </div>
